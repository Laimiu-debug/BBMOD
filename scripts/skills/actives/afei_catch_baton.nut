this.afei_catch_baton <- this.inherit("scripts/skills/skill", {
	m = { CooldownUntil = 0, IsSpent = false },
	function create()
	{
		this.m.ID = "actives.afei_catch_baton";
		this.m.Name = "接住这一棒";
		this.m.Description = "指定两格内友军：其下一次攻击命中+8。";
	...
	function onUse(_user, _targetTile)
	{
		...
		_targetTile.getEntity().getSkills().add(this.new("scripts/skills/effects/afei_bottle_breakthrough_ready"));
