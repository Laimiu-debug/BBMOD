this.afei_guard_self <- this.inherit("scripts/skills/skill", {
	m = { CooldownUntil = 0, IsSpent = false },
	function create()
	{
		this.m.ID = "actives.afei_guard_self";
		this.m.Name = "先护住自己";
		this.m.Description = "本轮生命伤害减免近似（近防+8）。";
	...
	function onUse(_user, _targetTile)
	{
		...
		_user.getSkills().add(this.new("scripts/skills/effects/afei_cover_up_effect"));
