this.afei_c24_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},
	function create()
	{
		this.character_background.create();
		this.m.ID = "background.afei_c24";
		this.m.Name = "糕糕";
		this.m.Icon = "ui/backgrounds/background_19.png";
		this.m.BackgroundDescription = "大飞午远征团命名伙伴 C24 · 糕糕。";
